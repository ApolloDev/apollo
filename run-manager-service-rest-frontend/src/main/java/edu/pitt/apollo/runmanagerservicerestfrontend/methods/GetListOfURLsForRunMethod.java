 ...
 * @author nem41
 */
public class GetListOfURLsForRunMethod extends BaseRunManagerServiceAccessorMethod {
	...
	public String getListOfURLsForRunMethod(BigInteger runId) throws UnsupportedSerializationFormatException, SerializationException {
		...
		try {
			Map<BigInteger, FileAndURLDescription> files = datastoreAccessImpl.getListOfURLsForRunId(runId, authentication);

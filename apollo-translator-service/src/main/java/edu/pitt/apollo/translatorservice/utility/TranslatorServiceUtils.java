...
import edu.pitt.apollo.services_common.v4_0_2.ServiceRegistrationRecord;
...
public class TranslatorServiceUtils {
	...
	private static final String AUTH_JWT_PROPERTY = "jwt";
	...
	static {
		...
		authentication.setPayload(properties.getProperty(AUTH_JWT_PROPERTY));

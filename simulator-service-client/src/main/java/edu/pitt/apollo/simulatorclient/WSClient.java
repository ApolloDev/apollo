...
public class WSClient {
	...
	public static final QName SERVICE = new QName("http://service.apollo.pitt.edu/simulatorservice/v4_0/", "SimulatorService_v4.0");

	public static void main(String[] args) throws MalformedURLException, InterruptedException {

		SimulatorServiceV40 simulatorService = new SimulatorServiceV40(new URL(WSDL_LOC), SERVICE);

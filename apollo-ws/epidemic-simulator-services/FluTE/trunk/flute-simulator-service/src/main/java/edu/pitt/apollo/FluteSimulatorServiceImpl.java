...
import edu.pitt.apollo.flute.utils.BatchThread;
...
//			System.err
//					.println("Fatal Error enountered retrieving stored run hashes. Specific error message was:\n"
//							+ e.getMessage());
//			e.printStackTrace();
//			System.exit(-1);
...
//				} catch (IOException ex) {
//					System.err
//							.println("IO exception writing current ID to file");
//				}
//			}
//		}));
...
/*		try {
			...
			String simConfigHash = RunUtils.getMd5HashFromBytes(baos
					.toByteArray());

			SoftwareIdentification sid = simulatorConfiguration
...
//		}
	...
	public static ByteArrayOutputStream getJSONBytes(
		...
		try {
			...
			System.err
					.println("IO Exception JSON encoding and getting string from SimulatorConfiguration");
			return null;
		}
	}

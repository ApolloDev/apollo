################################################## 
# SimulatorService_services_types.py 
...
class ns0:
    ...
    class run_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("http://types.apollo.pitt.edu/","SimulatorConfiguration",lazy=True)(pname="simulatorConfiguration", aname="_simulatorConfiguration", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded"))]
    ...
    class getSupportedLocationsResponse_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [GTD("http://types.apollo.pitt.edu/","SupportedPopulationLocation",lazy=True)(pname="supportedPopluationLocations", aname="_supportedPopluationLocations", minOccurs=1, maxOccurs="unbounded", nillable=False, typed=False, encoded=kw.get("encoded"))]

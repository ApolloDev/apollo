...
class EpiModelService(EpidemicSimulatorService):
        ...
        def soap_getJobStatus(self, ps, **kw):
            request, response = EpidemicSimulatorService.soap_getJobStatus(self, ps, **kw)
            ...
            response._message = "The run completed successfully at 11/25/2012 16:34"
        ...
        def soap_getResult(self, ps, **kw):
            ...
            epidemic_model_output._population_time_series._population = ["susceptible", "exposed", "infectious", "recovered"]
            ...
            response._return = epidemic_model_output
            return request, response
        ...
        def soap_getSimulatorDescription(self, ps, **kw):
            ...
            response._return = "This simulator does not run any models.  This is an example service."
            return request, response

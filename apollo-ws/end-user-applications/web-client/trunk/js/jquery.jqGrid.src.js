...
$.fn.jqGrid = function( pin ) {
    ...
    return this.each( function() {
        ...
        parseFloat($.browser.version)<536.11 ? true : false; // Chrome < version 19
        ts = this;
            ...
            $.ajax($.extend({
                ...
                error:function(res,stat){
                    ...
                    if($.isFunction(o.errorfunc) ) {
                        ...
                        try {
                            jQuery.jgrid.info_dialog(jQuery.jgrid.errors.errcap,'<div class="ui-state-error">'+ res.responseText +'</div>', jQuery.jgrid.edit.bClose,{
                                buttonalign:'right'
                            });
                        }
                        catch(e) {
        ...
        editCell : function (iRow,iCol, ed){
            return this.each(function (){
                ...
                if ($t.p.colModel[iCol].editable===true && ed===true && !cc.hasClass("not-editable-cell")) {
                    ...
                    var opt = $.extend({}, $t.p.colModel[iCol].editoptions || {} ,{
                        id:iRow+"_"+nm,
                        name:nm
                    });

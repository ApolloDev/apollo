        ...
        <div id="main">
            ...
            <div id="LeftPane" class="ui-layout-west ui-widget ui-widget-content">
                <div id="west-div">
                    ...
                    <div style="text-align: center; display: table; width: 80%; margin-left: auto; margin-right: auto">
                        <div style="display: table-row;">
                            <div style="display: table-cell; text-align: left; vertical-align: middle">
                                <div style="margin-left: auto; margin-right: auto; width: 80%">
                                    <div>Pathogen:</div>
                                    <div>
                                        <select name="disease-combo" id="disease-combo" style="width: 135px;">
                                            <!--                                            <option value="select">Select pathogen</option>-->
                                    ...
                                    <div style="display: table; width: 100%">
                                        ...
                                        <div style="display: table-row">
                                            ...
                                            <div style="display: table-cell">
                                                <select id="state-select" onChange="stateComboBoxOnChange(true)" style="width: 110px">
                                                    <option value="select">Select</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div style="display: table-row">
                                            <div style="display: table-cell;">County: </div> 
                                            <div style="display: table-cell">
                                                <select id="county-select" onChange="countyComboBoxOnChange()" style="width: 110px">
                    ...
                    <div id="model-div" class="drop-box-div" style="display: table; margin-left: auto; margin-right: auto; width: 80%">
                        <div style="display: table-row">
                            <div style="display: table-cell">
                                <div style="text-align: left; margin-left: auto; margin-right: auto; width: 320px">    
                                    <div>Epidemic Simulators:</div>
                                    <div>
                                        <select id="model-combo" onChange="epidemicModelSelectOnChange()" size="4" multiple="multiple" disabled style="width: 320px">
                        ...
                        <div style="display: table-row">
                            <div style="text-align: right; margin-left: auto; margin-right: auto; width: 320px">
                                <button type="button" onClick="resetEpiSimulatorSelection()">Reset</button>
                            </div>
                        </div>
                    </div>
                    <br/>
            ...
            <div id="CenterPane"
                ...
                <div id="tabs" class="jqgtabs">
                    ...
                    <div id="tabs-1">
                        ...
                        <ol>
                            <li>In the panel on the left under the "Epidemic Simulator Selection" section, choose a population location by first
                                selecting a state and then selecting a county. After choosing a location, select one or more epidemic simulators.
                        ...
                        When one or more epidemic simulators are selected, the list of available states and counties
                        will change to show only those regions that are supported by all selected epidemic simulators. When
                        a state or county is selected, the list of epidemic simulators will change to show only those
                        simulators that support the selected region. 
                        <br/><br/>
                        If a single state is desired, select "Entire State" in the county box after selecting a state in the state box.
                        Clicking on the "Reset" button will reset the "Epidemic Simulator Selection" section to its
                        default state.

...
var antiviralAdminSchedule = new function(){
    //private functions
    ...
    function onGridAddClicked(){
        ...
        if (currMode == 'rate'){//update the delivery rate number
            ...
            var currentCount = parseInt( $('#antiviral-admin-delivery-rate-change').val() );
            currentCount++;
            $('#antiviral-admin-delivery-rate-change').val(currentCount);
            ...
            var currentCount = parseInt( $('#antiviral-admin-delivery-number').val() );
            currentCount++;
            $('#antiviral-admin-delivery-number').val(currentCount);
        }
    ...
    function getAntiviralSchedule(){
        ...
        var rowData = jqgridHelper.findDataByValue(mainGrid, 'pname', 'Antiviral Administration Schedule');

        if (rowData.length == 0)
            throw "Can't get Antiviral Administration Schedule";
    ...
    function initChart(rawData){		
        ...
        chart = new Highcharts.Chart({
            chart: {
                renderTo: 'antiviral-admin-delivery-chart',
    ...
    function initRateGrid(){
        ...
        //unload grid first
        deliveryGrid = $("#antiviral-admin-delivery-table");
        ...
        deliveryGrid.jqGrid({
            ...
            beforeSaveCell : function (	rowid, cellname, value, iRow, iCol){
                ...
                var dateVal = $( "#antiviral-admin-date-of-first-delivery" ).val();
    ...
    function loadRateAry(mydata){
        ...
        $('#antiviral-admin-delivery-rate-change').val(mydata.length - 1);
		
        //hide the table control
        $('#antiviral-admin-delivery-number-div').hide();
        //show the rate control
        $('#antiviral-admin-delivery-rate-div').show();
    }
    ...
    function initTableGrid(rawData){
        ...
        //set the rate control (number of delivery)
        $('#antiviral-admin-delivery-number').val(mydata.length);
		
        //show the table control
        $('#antiviral-admin-delivery-number-div').show();
        //hide the rate control
        $('#antiviral-admin-delivery-rate-div').hide();
    };
	
    function initControl(){
        var beginDatePicker = $( "#antiviral-admin-date-of-first-delivery" )
        ...
        //		$('#antiviral-admin-delivery-table-add').button().click(onGridAddClicked);
        //		$('#antiviral-admin-delivery-table-insert').button().click(onGridInsertClicked);
        //		$('#antiviral-admin-delivery-table-delete').button().click(onGridDeleteClicked);
        $('#antiviral-admin-delivery-table-add').button().click();
        $('#antiviral-admin-delivery-table-insert').button().click();
        $('#antiviral-admin-delivery-table-delete').button().click();
        $('#antiviral-admin-delivery-table-add').button().hide();
        $('#antiviral-admin-delivery-table-insert').button().hide();
        $('#antiviral-admin-delivery-table-delete').button().hide();
		
        $('#antiviral-admin-schedule-submit').button().click(function (){
            //if user is still editing the table
            //        if (deliveryGrid.find('input').length != 0){
            ...
            //            throw "Can't find Antiviral Administration Schedule Parameter!";
            //			
            //        rowData = rowData[0];
            //			
        ...
        $('#antiviral-admin-schedule-submit').button().hide();
                
        $('#antiviral-admin-rate-mode').click(onRateMode);
        $('#antiviral-admin-table-mode').click(onTableMode);
    };
    ...
    function onRateMode(){
        ...
        $('#antiviral-admin-delivery-table-insert').button( "option", "disabled", false );
    };
    ...
    function onTableMode(){
        ...
        $('#antiviral-admin-delivery-table-insert').button( "option", "disabled", true );
    };
...
var antivadmins = antiviralAdminSchedule.init();
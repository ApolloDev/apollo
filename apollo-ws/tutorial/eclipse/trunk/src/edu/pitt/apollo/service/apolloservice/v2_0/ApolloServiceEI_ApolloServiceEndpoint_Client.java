...
public final class ApolloServiceEI_ApolloServiceEndpoint_Client {
	...
	private ApolloServiceEI_ApolloServiceEndpoint_Client(URL wsdlURL) {
	...
	public static void main(String args[]) throws java.lang.Exception {
		...
		ApolloServiceEI_ApolloServiceEndpoint_Client client = new ApolloServiceEI_ApolloServiceEndpoint_Client(
				wsdlURL);

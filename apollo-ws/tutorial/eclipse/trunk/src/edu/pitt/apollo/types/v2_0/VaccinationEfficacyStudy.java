 ...
 *         &lt;element name="vaccinationPreventableOutcome" type="{http://types.apollo.pitt.edu/v2_0/}VaccinationPreventableOutcome"/>
 *         &lt;element name="vaccinationEfficacyMeasured" type="{http://types.apollo.pitt.edu/v2_0/}VaccinationEfficacyMeasured" maxOccurs="unbounded"/>
...
public class VaccinationEfficacyStudy {
    ...
    protected VaccinationPreventableOutcome vaccinationPreventableOutcome;
    @XmlElement(required = true)
     ...
     *     
     */
    public VaccinationPreventableOutcome getVaccinationPreventableOutcome() {
     ...
     *     
     */
    public void setVaccinationPreventableOutcome(VaccinationPreventableOutcome value) {

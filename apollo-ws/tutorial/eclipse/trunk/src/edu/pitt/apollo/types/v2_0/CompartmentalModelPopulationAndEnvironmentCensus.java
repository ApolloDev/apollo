 ...
 *       &lt;sequence>
 *         &lt;element name="bioticEcosystemParts" type="{http://types.apollo.pitt.edu/v2_0/}PopulationInfectionAndImmunityCensusData" maxOccurs="unbounded"/>
 *         &lt;element name="abioticEcosystemParts" type="{http://types.apollo.pitt.edu/v2_0/}abioticEcosystemPartCensus" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CompartmentalModelPopulationAndEnvironmentCensus {
    ...
    @XmlElement(required = true)
    protected List<AbioticEcosystemPartCensus> abioticEcosystemParts;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AbioticEcosystemPartCensus }
     * 
     * 
     */
    public List<AbioticEcosystemPartCensus> getAbioticEcosystemParts() {
        if (abioticEcosystemParts == null) {
            abioticEcosystemParts = new ArrayList<AbioticEcosystemPartCensus>();
        }

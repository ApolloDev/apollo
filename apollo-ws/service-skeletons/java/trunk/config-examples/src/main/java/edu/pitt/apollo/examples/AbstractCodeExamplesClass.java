...
public abstract class AbstractCodeExamplesClass {
    ...
    protected static Infection getInfection(String pathogenTaxonId, String hostTaxonId,
        ...
        InfectionAcquisitionFromInfectiousHost infectionAcquisitionFromInfectiousHost =
                getInfectionAcquisitionFromInfectiousHost(hostTaxonId, reproductionNumber, latentPeriod, infectiousPeriod, unitOfTimeEnum);
        infection.getInfectionAcquisitionsFromInfectiousHosts().add(infectionAcquisitionFromInfectiousHost);
        
        return infection;
    }
    
    private static InfectionAcquisitionFromInfectiousHost getInfectionAcquisitionFromInfectiousHost(String infectiousHostTaxonId,
            double reproductionNumber, double latentPeriod, double infectiousPeriod, UnitOfTimeEnum unitOfTimeEnum) {

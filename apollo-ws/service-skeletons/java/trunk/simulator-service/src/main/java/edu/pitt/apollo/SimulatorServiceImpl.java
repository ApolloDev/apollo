...
public abstract class SimulatorServiceImpl implements SimulatorServiceEI {
    ...
    @WebMethod(action = "http://service.apollo.pitt.edu/simulatorservice/v2_0_2/runSimulation")
    @ResponseWrapper(localName = "runSimulationResponse", targetNamespace = "http://service.apollo.pitt.edu/simulatorservice/v2_0_2/", className = "edu.pitt.apollo.service.simulatorservice.v2_0_2.RunSimulationResponse")

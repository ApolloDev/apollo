...
public class TutorialChapter9_LibraryExample extends
	...
	public void loadInfection() {
		...
		Infection infection = (Infection) infectionItem.getCuratedLibraryItemContainer()
		...
		System.out.println("\t\tPathogen Taxon ID: "
				+ infectionAcquisition.getPathogenTaxonId().getNcbiTaxonId());
	...
	public void loadVaccinationControlStrategy() {
		...
		if (vaccinationControlStrategy.getControlStrategyResponseDelay() instanceof FixedDuration) {
			System.out.println("\tResponse Delay: "
					+ ((FixedDuration) vaccinationControlStrategy.getControlStrategyResponseDelay())
							.getValue());
		}
	...
	public InfectiousDiseaseScenario loadInfectiousDiseaseScenario() {
		...
		InfectionAcquisition infectionAcquisition = infectiousDiseaseScenario.getInfections().get(0)
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		InfectiousDiseaseScenario infectiousDiseaseScenario = tutorialChapter9
		...
		RunSimulationMessage runSimulationMessageWithNormalR0 = tutorialChapter9.chapter8Config
		...
		RunSimulationMessage runSimulationMessageWithHighR0 = tutorialChapter9.chapter8Config
				.getRunSimulationMessage();
		...
		tutorialChapter8.createIncidenceVisualizationForMultipleSimulations(ExampleRunSimulationMessageFactory
				.getAuthentication(ExampleRunSimulationMessageFactory.REQUESTER_ID,
						ExampleRunSimulationMessageFactory.REQUESTER_PASSWORD), normalR0runAndSoftwareId
				.getRunId(), highR0RunAndSoftwareId.getRunId());
	}

...
public class TutorialWebServiceClient {
	...
	public TutorialWebServiceClient() throws MalformedURLException {
	...
	private List<String> getScenarioLocationCodesSupportedBySimulatorOrNull(
		...
		GetScenarioLocationCodesSupportedBySimulatorResult resultOfGetScenarioLocationCodesSupportedBySimulatorWebServiceCall = getPort()
	...
	public PopulationAndEnvironmentCensus getPopulationAndEnvironmentCensus(SoftwareIdentification simulatorSoftwareIdentification, String apolloLocationCode) {
		GetPopulationAndEnvironmentCensusResult getPopulationAndEnvironmentCensusResult = getPort()
				.getPopulationAndEnvironmentCensus(simulatorSoftwareIdentification, apolloLocationCode);

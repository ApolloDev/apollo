...
INSERT INTO `software_identification` VALUES (1,'UPitt','Translator','1.0','translator','http://localhost:8080/translatorservice-2.1.0-SNAPSHOT/services/translatorservice?wsdl',1),
											 (2,'UPitt','SEIR','3.0','simulator','http://localhost:8080/pittsimulatorservice-2.1.0-SNAPSHOT/services/pittsimulatorservice?wsdl',1),
											 (3,'UPitt,PSC,CMU','FRED','2.0.1_i','simulator','http://gaia.pha.psc.edu:8095/pscsimu?wsdl',1),
											 (4,'UPitt','Time Series Visualizer','1.0','visualizer','http://localhost:8080/visualizerservice-2.1.0-SNAPSHOT/services/visualizerservice?wsdl',1),
											 ...
											 (7,'UPitt','Anthrax','1.0','simulator','http://localhost:8080/pittsimulatorservice-2.1.0-SNAPSHOT/services/pittsimulatorservice?wsdl',1),
                                             (8,'PSC','CLARA','0.5','simulator','http://gaia.pha.psc.edu:8095/pscsimu?wsdl',1),
                                             (9,'Steve Bellan','Lancet Ebola','1.0','simulator','http://localhost:8080/pittsimulatorservice-2.1.0-SNAPSHOT/services/pittsimulatorservice?wsdl',1);

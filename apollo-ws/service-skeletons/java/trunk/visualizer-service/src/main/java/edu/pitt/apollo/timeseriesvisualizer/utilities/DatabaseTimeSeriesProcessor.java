 ...
 * Date: Feb 27, 2014
 * Time: 2:29:19 PM
 * Class: DatabaseTimeSeriesProcessor
 * IDE: NetBeans 6.9.1
 */
public class DatabaseTimeSeriesProcessor {
    ...
    private void setTimeSeriesEntry(String diseaseState, String location, int timeStep, double populationCount) {
    ...
    public void storeTimeSeriesFromResultSet(ResultSet resultSet) throws SQLException, TimeSeriesVisualizerException {
        ...
        while (resultSet.next()) {
            ...
            setTimeSeriesEntry(diseaseState, location, timeStep, populationCount);
        }
    ...
    public void storeTimeSeriesFromDatabaseFiles(Map<String, ByteArrayOutputStream> map) {
        ...
        for (String label : map.keySet()) {
            ...
            while (scanner.hasNextLine()) {
                ...
                setTimeSeriesEntry(diseaseState, DEFAULT_LOCATION, timeStep, populationCount);
            }
        }

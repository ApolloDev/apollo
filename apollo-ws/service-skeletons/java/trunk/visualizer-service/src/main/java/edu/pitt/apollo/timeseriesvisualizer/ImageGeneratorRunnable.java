...
//		ApolloDbUtils dbUtils = DatabaseUtility.getDbUtils();
        try {
            DatabaseUtility.updateStatusOfVisualizerRun(visualizerRunId, MethodCallStatusEnum.RUNNING,
        ...
        try {
            ...
            try {
                DatabaseUtility.updateStatusOfVisualizerRun(visualizerRunId, MethodCallStatusEnum.FAILED,
                        "TimeSeriesVisualizerException creating ImageGenerator: " + e.getMessage());
            } catch (TimeSeriesVisualizerException e1) {
        ...
        try {
            ...
            try {
                DatabaseUtility.updateStatusOfVisualizerRun(visualizerRunId, MethodCallStatusEnum.FAILED,
                        "TimeSeriesVisualizerException creating ImageGenerator: " + ex.getMessage());
...
//                        "Exception running Time-series visualizer: " + ex.getMessage());
        ...
        try {
            DatabaseUtility.updateStatusOfVisualizerRun(visualizerRunId, MethodCallStatusEnum.COMPLETED,

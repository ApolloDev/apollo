...
@WebService(targetNamespace = "http://service.apollo.pitt.edu/visualizerservice/v4_0/", portName = "VisualizerServiceEndpoint", serviceName = "VisualizerService_v4.0", endpointInterface = "edu.pitt.apollo.service.visualizerservice.v4_0.VisualizerServiceEI")
class VisualizerServiceImpl implements VisualizerServiceEI {

   

    @Override
    @RequestWrapper(localName = "runVisualization", targetNamespace = "http://service.apollo.pitt.edu/visualizerservice/v4_0/", className = "edu.pitt.apollo.service.visualizerservice.v4_0.RunVisualization")
    @WebMethod(action = "http://service.apollo.pitt.edu/visualizerservice/v4_0/runVisualization")
    @ResponseWrapper(localName = "runVisualizationResponse", targetNamespace = "http://service.apollo.pitt.edu/visualizerservice/v4_0/", className = "edu.pitt.apollo.service.visualizerservice.v4_0.RunVisualizationResponse")

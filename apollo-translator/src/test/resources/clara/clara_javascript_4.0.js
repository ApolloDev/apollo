...
function getCoverRadius(controlStrategyType, controlStrategies) {
    ...
    for (var i = 0; i < controlStrategies.size(); i++) {
        ...
        if (cm instanceof edu.pitt.apollo.types.v4_0_2.ContainerReductionControlMeasure) {
            currentCmType = "indoorResidualSpraying";
        } else if (cm instanceof edu.pitt.apollo.types.v4_0_2.LarvicideControlMeasure) {
            currentCmType = "larvicide";
        } else if (cm instanceof edu.pitt.apollo.types.v4_0_2.IndoorResidualSprayingVectorControlMeasure) {
        ...
        if (smallestCoverRadius == null || (coverRadius < smallestCoverRadius)) {
            ...
            if (cm instanceof edu.pitt.apollo.types.v4_0_2.IndoorResidualSprayingVectorControlMeasure) {
            ...
            } else if (cm instanceof edu.pitt.apollo.types.v4_0_2.ContainerReductionControlMeasure) {
                smallestCoverRadiusCm = "infectiousDiseaseControlStrategy[" + i + "]";
...
function getControlStrategyTime(triggers) {
    ...
    for (var i = 0; i < triggers.size(); i++) {
        ...
        if (trigger instanceof edu.pitt.apollo.types.v4_0_2.TemporalTriggerDefinition) {
            var startTime = trigger.getTimeSinceTimeScaleZero();
            if (startTime instanceof edu.pitt.apollo.types.v4_0_2.FixedDuration) {

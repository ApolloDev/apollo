 ...
 */
public class SetLibraryItemReleaseVersionMethod extends BaseBrokerServiceAccessorMethod {
	...
	public String setLibraryItemReleaseVersion(int urn, int version, String comment) throws SerializationException {

		try {
			SetReleaseVersionResult result = impl.approveRevisionOfLibraryItem(urn, version, comment, authentication);
			...
			serializationInformation.setClassName(SetReleaseVersionResult.class.getSimpleName());

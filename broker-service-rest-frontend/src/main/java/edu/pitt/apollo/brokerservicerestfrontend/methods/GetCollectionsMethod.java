...
import edu.pitt.apollo.library_service_types.v4_0_1.GetCollectionsResult;
 ...
 */
public class GetCollectionsMethod extends BaseBrokerServiceAccessorMethod {
	...
	public String getCollections(String className, Boolean includeUnreleasedItems) throws SerializationException {
		...
		try {
			...
			serializationInformation.setClassName(GetCollectionsResult.class.getSimpleName());

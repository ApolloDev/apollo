 ...
 */
public class GetApprovedRevisionOfLibraryItemMethod extends BaseBrokerServiceAccessorMethod {

	public GetApprovedRevisionOfLibraryItemMethod(SerializationFormat serializationFormat, String authorizationHeader) throws UnsupportedSerializationFormatException, UnsupportedAuthorizationTypeException {
	...
	public String getLibraryItemReleaseVersion(int urn) throws SerializationException {
		...
		try {
            ...
            serializationInformation.setClassName(GetReleaseVersionResult.class.getSimpleName());

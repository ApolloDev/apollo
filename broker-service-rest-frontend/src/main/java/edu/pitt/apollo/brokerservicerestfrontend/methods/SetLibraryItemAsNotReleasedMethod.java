 ...
 */
public class SetLibraryItemAsNotReleasedMethod extends BaseBrokerServiceAccessorMethod {
	...
	public String hideLibraryItem(int urn) throws SerializationException {
		try {
			SetLibraryItemAsNotReleasedResult result = impl.hideLibraryItem(urn, authentication);
			...
			serializationInformation.setClassName(SetLibraryItemAsNotReleasedResult.class.getSimpleName());

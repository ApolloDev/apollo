 ...
 */
public class GetCommentsForLibraryItemMethod extends BaseBrokerServiceAccessorMethod {
	...
	public String getCommentsForLibraryItem(int urn, int version) throws SerializationException {
		...
		try {
            ...
            serializationInformation.setClassName(GetCommentsResult.class.getSimpleName());

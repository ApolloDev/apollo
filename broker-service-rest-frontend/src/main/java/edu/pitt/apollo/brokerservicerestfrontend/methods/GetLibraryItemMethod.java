 ...
 */
public class GetLibraryItemMethod extends BaseBrokerServiceAccessorMethod {

	public GetLibraryItemMethod(SerializationFormat serializationFormat, String authorizationHeader) throws UnsupportedSerializationFormatException, UnsupportedAuthorizationTypeException {
		super(serializationFormat, authorizationHeader);
	}

	public String getLibraryItem(int urn, Integer version) throws SerializationException {
		...
		try {
            ...
            serializationInformation.setClassName(GetLibraryItemContainerResult.class.getSimpleName());

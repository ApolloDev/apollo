...
/**
 *
 * Author: Nick Millett Email: nick.millett@gmail.com Date: Jan 22, 2015 Time: 10:24:52 AM Class: DatastoreAccessorForRunningDataRetrievalJob
 */
public class DatastoreAccessorForRunningDataRetrievalJob extends DatastoreAccessor {
...
//	public DatastoreAccessorForRunningDataRetrievalJob(GetOutputFilesURLsMessage message, Authentication authentication, ApolloDbUtils dbUtils) throws ApolloDatabaseException {
...
//	public DatastoreAccessorForRunningDataRetrievalJob(GetAllOutputFilesURLAsZipMessage message, Authentication authentication, ApolloDbUtils dbUtils) throws ApolloDatabaseException {
//		super(authentication, dbUtils);

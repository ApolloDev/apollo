...
import edu.pitt.apollo.service.translatorservice.v3_0_2.TranslatorServiceV302;
...
public class SoapTranslatorServiceConnector extends TranslatorServiceConnector {
	...
	private void initialize() throws TranslatorServiceException {
		try {
			port = new TranslatorServiceV302(new URL(serviceUrl)).getTranslatorServiceEndpoint();
		} catch (Exception ex) {

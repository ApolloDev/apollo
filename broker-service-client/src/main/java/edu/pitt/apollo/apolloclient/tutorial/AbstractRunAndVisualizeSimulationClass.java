...
//			runVisualizationMessage.getSimulationRunIds().add(runIdentificationAndLabel);
		...
		if (TutorialWebServiceClient.waitForRunToCompleteOrFail(visualizationRunId, runVisualizationMessage.getAuthentication()) == TutorialWebServiceClient.RUN_WAS_SUCCESSFUL) {

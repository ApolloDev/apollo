...
public class RestRun {
     ...
     */
    private static final String REST_ENDPOINT = "http://betaweb.rods.pitt.edu/broker-service-rest-frontend-3.1.0-SNAPSHOT/";

    /**
     * The connection to the Rest Service.
     */
    RestBrokerServiceConnector connector;
    /**
    ...
    protected boolean waitForRunToCompleteOrFail() throws RunManagementException {
        ...
        *//*request.setAuthentication(authentication);*//*
        while (true) {
            try {
                Thread.sleep(2000);
                MethodCallStatus callStatus = null;

                callStatus = connector.getRunStatus(runIdentification, authentication);
